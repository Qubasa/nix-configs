...
[global]
    ...
    i#con_path = /usr/share/icons/gnome/16x16/status/:/usr/share/icons/gnome/16x16/devices/
...
# [script-test] */
#     summary = "*script*" */
#     script = /home/mainUser/.config/dunst/dunst_test.sh */
...
in {
  ...
  system.activationScripts.copyDunstConfig = ''
      CONFIG_FOLDER=${config.mainUserHome}/.config/dunst
      CONFIG_FILE_PATH=$CONFIG_FOLDER/dunstrc
